...
public class MaplibreUtils {
    ...
    public static final LatLng fromDJILatLng(DJILatLng latLng) {
        DJILatLng displayCoordinate = DJIGpsUtils.wgs2gcjInChina(latLng);
        return new LatLng(displayCoordinate.getLatitude(), displayCoordinate.getLongitude(), displayCoordinate.getAltitude());
    }
