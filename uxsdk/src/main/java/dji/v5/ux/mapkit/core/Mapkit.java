...
public class Mapkit {
    ...
    private static final String CLASS_PROVIDER_BAIDU = "dji.v5.ux.mapkit.baidu.provider.BaiduProvider";
   // private static final String CLASS_PROVIDER_MAPLIBRE = "dji.v5.ux.mapkit.maplibre.provider.MapLibreProvider";
    ...
    static {
        ...
        providerClassName.put(MapProviderConstant.BAIDU_PROVIDER, CLASS_PROVIDER_BAIDU);
    }
    ...
    @IntDef({MapProviderConstant.INVALID_PROVIDER, MapProviderConstant.GOOGLE_MAP_PROVIDER,
     ...
     MapProviderConstant.BAIDU_PROVIDER})
